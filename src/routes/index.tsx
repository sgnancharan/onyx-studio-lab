...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    whatWeOffer: [
      "Assembly fee ranges from ₹4,999 to ₹5,999 depending on the complexity of the build (e.g., custom water cooling, ITX form factors, or extensive RGB routing)",
...
function Estimator() {
  ...
  const [pcTier, setPcTier] = useState<string>("none");
